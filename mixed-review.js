...
// let yournum = readline.question("pick a number: ");
...
// //your function is correct, these should both print true.
...
// for (var i = 0; i < arr.length; i++) {
//   let array = arr[i] ;
//   return array.charAt(arr.length-1);
//   for (var j = 0; j < num.length; j++) {
//     let number = num[j] ;

//     return number.charAt(num.length-1);
//   } 
// }
// If your function is correct, these should both print true.
...
// function waitFor24() {
//   let playernum= readline.question("please type a number: ");
//   let computernum = 24;

//   if (playernum == computernum ) {
//     console.log("Yay you guessed correct");
//   }
//   else if (! playernum == computernum) {
//     console.log(playernum +  " is incorrect please try again");
//     }
//   }
