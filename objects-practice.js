...
// var anyObj = {alex:15, jackie:15, Madison:12};
// console.log(anyObj);
// // Delete one of the key-value pairs.
// delete anyObj.jackie;
// console.log(anyObj);
// // Add a new one.
// anyObj.Cindy = 16;
// console.log(anyObj);
...
function letterCount(str) {
	...
	for (var i = 0; i < str.length; i++) {
		...
		if (word.hasOwnProperty(eachLetter) == false) {
			word[eachLetter] = 1;
		}
		else {
			word[eachLetter]++;
