...
//   let twolast = arr.length-2;
//   for (var i = 0; i < arr.length; i++) {
//     let number = arr[twolast];
...
function moveLast(arr) {
  for (var i = 0; i < arr.length; i++) {
    ...
    let begin = arr[last];
  let newarray = (begin , last) ;
  return newarray;
  }
}
  console.log(moveLast([2,4,5,7]));
// Here is one test. Uncomment it when ready and try adding more.
...
//   let beginningLetter = arr[i];
//   for (var i = 0; i > arr.length; i++) {
//     console.log(arr.charAt(0));
//   }
//   return beginningLetter;
// }
// firstLetter(["happy","camper","time"]);
// // Here is one test. Uncomment it when ready and try adding more.
